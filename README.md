...
The application is developed with HTML, CSS, JavaScript and Electron as a desktop wrapper.
...
StochSD Can also be run as a *StochSD Desktop* application using Electron. This enables a few extra features for file-handeling such as *Save As..* function and *recent-files*. Run `npm install && npm run electron` from the repo root to launch it from source; see `distribute/README.md` for building installers.
